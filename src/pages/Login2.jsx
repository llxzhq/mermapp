...
export default function Login2() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      await fetch("http://192.168.212.69:4443/auth/forgot-password", {
        method: "POST",
        headers: {
    ...
    <div className="min-h-screen bg-[#f6f7fb] flex flex-col justify-between">
      <div className="flex-1 flex flex-col justify-center px-6">
        ...
        >
          ...
          <p className="text-sm text-gray-400 mb-6">Ingresa tus credenciales</p>
          ...
          {attempts > 0 && !isLocked && (
            <p className="text-[11px] text-gray-400 mt-3 text-center">Intentos fallidos: {attempts}/5</p>
          )}
        </motion.div>
      </div>
